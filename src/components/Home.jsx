  ...
  return (
    <div className='w-full h-screen'>
        ...
        <div className='max-w-[1000px] mx-auto px-8 flex flex-col justify-center h-full'>
            ...
            <div>
                <button className='dark:text-white group border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600'>View Work<HiArrowNarrowRight className='ml-3' /></button>
            </div>
        </div>
    </div>
  )
