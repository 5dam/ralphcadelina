          ...
          <div
            ...
            <div className="opacity-0 group-hover:opacity-100 ">
              ...
              <div className='pt-8 text-center'>
                ...
                <a href="https://github.com/tsujintsujin/KokusaiDaigaku" target="_blank">
          ...
          <div
            ...
            <div className="opacity-0 group-hover:opacity-100 ">
              ...
              <div className='pt-8 text-center'>
                ...
                <a href="https://github.com/PrgDominique/kodegoattendance" target="_blank">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white hover:scale-110 dark:text-black'>Code</button>
                </a>
              </div>
            </div>
          ...
          <div
            ...
            <div className="opacity-0 group-hover:opacity-100 ">
              ...
              <div className='pt-8 text-center'>
                ...
                <a href="https://github.com/5dam/majorproject1-moveme" target="_blank">
                  <button className='text-center rounded-lg px-4 py-3 m-2 bg-white hover:scale-110 dark:text-black'>Code</button>
                </a>
              </div>
            </div>
